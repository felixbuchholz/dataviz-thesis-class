...
* Write the result to the persons.csv file 
	putexcel set "/Users/felixbuchholz/repos/thesis/data/stata/meanhh_persons_by_inccat.csv", replace
	putexcel A1=matrix(r(table)), names
...
* Write the result to the adults.csv file 
	putexcel set "/Users/felixbuchholz/repos/thesis/data/stata/meanhh_adults_by_inccat.csv", replace
	putexcel A1=matrix(r(table)), names
...
* Write the result to the persons.csv file 
	putexcel set "/Users/felixbuchholz/repos/thesis/data/stata/totalhh_persons_by_inccat.csv", replace
	putexcel A1=matrix(r(table)), names
